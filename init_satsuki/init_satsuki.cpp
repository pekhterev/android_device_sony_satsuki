        ...
        const std::string& value, bool for_emulator __attribute__((unused)))
{
    ...
    if (key == "oemandroidboot.phoneid") {
        property_set("ro.semc.content.number","PA27");
        property_set("ro.semc.product.device","E68");
        property_set("ro.semc.version.cust","1299-4830");
        property_set("ro.semc.version.cust.active","");
        property_set("ro.semc.version.cust_revision","R3D");
        property_set("ro.semc.version.fs","GENERIC");
        property_set("ro.semc.version.fs_revision", "32.4.A.0.160");
        property_set("ro.semc.version.sw","1296-2432");
        property_set("ro.semc.version.sw_revision", "32.4.A.0.160");
        property_set("ro.semc.version.sw_variant","GLOBAL-LTE2A");
        ...
        if ((count(value.begin(), value.end(),',')) > 0) {
            ...
            property_set("ro.semc.ms_type_id","PM-0913-BV");
            ...
            property_set("ro.semc.ms_type_id","PM-0911-BV");
